...
<div id="wrap-inner">
	<div id="product-info">
		...
		<h3>Điện thoại {{$item->prod_name}}</h3>
		<div class="row">
			<div id="product-img" class="col-xs-12 col-sm-12 col-md-4 text-center">
				<img width="300px" height="350px" src="{{asset('lib/storage/app/avatar/'.$item->prod_img)}}">
			</div>
			<div id="product-details" class="col-xs-12 col-sm-12 col-md-8">
				...
				<p>Trạng thái: {{($item->prod_status == 1) ? 'Còn hàng' : 'Hết hàng'}}</p>
