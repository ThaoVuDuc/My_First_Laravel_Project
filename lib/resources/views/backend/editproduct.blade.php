							...
							<div class="col-xs-8">
								...
								<div class="form-group" >
									...
									<select required name="status" class="form-control">
										<option value="1" {{$product->status == 1 ? 'checked' : ''}}>Còn hàng</option>
										<option value="0" {{$product->status == 0 ? 'checked' : ''}}>Hết hàng</option>
				                    </select>
								</div>
								<div class="form-group" >
									<label>Miêu tả</label>
								...
								<div class="form-group" >
									...
									<select required name="cate" class="form-control">
										...
										<option value="1" {{$product->prod_cate == $cate->cate_id ? 'selected' : ''}}>{{$cate->cate_name}}</option>
										@endforeach
									</select>
								</div>
								<div class="form-group" >
									<label>Sản phẩm nổi bật</label><br>
									Có: <input type="radio" name="featured" value="1" {{$product->prod_featured == 1 ? 'checked' : ''}}>
									Không: <input type="radio" name="featured" value="0" {{$product->prod_featured == 0 ? 'checked' : ''}}>
								</div>
