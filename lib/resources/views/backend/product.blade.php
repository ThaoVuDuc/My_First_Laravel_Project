								...
								<tbody>
									...
									<tr>
										...
										<td>
											...
											<a href="{{asset('admin/product/delete/'.$product->prod_id)}}" class="btn btn-danger" onclick="return confirm('Bạn có chắc chắn muốn xóa !')"><i class="fa fa-trash" aria-hidden="true"></i> Xóa</a>
										</td>
									</tr>
									@endforeach
								</tbody>
